...
class ThesisController extends Controller
{
    public function index(){
        //$theses = Thesis::all();
        //$theses = Thesis::select('')->where()->get();
        $theses = Thesis::join('users','theses.email','=','users.email')
        ->select('theses.id as id','theses.thesis_code as thesis_code','theses.title as title','theses.state as state','users.name as name')
        ->get();
